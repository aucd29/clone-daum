...
import com.example.clone_daum.databinding.*
...
class MainFragment constructor(
    ...
    private lateinit var realtimeIssueTabAdapter: RealtimeIssueTabAdapter
    ...
    override fun initViewBinding() {
        mainTabAdapter = MainTabAdapter.create(childFragmentManager, preConfig)
    ...
    private fun loadRealtimeIssueTab() {
        issueViewModel.apply {
            realtimeIssueTabAdapter = RealtimeIssueTabAdapter.create(childFragmentManager)

            val adapter = realtimeIssueTabAdapter
